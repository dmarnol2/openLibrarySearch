...
User can click a bar in the chart to get more information. Images of book covers that satisfy the search criteria for that time frame are displayed. Clicking the book cover navigates user to the book item on the Open Library site.
